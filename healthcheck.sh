...
CATALINA_LOG_PATH="/var/lib/tomcat/logs/catalina.out"
CATALINA_LOG_DIR="/var/lib/tomcat/logs"
REPORT_FILE="/var/log/healthcheck/health-check-$(date +%Y%m%d).log"
EMAIL_RECIPIENT="sasank.k@polussolutions.com"
MYSQL_HOST="127.0.0.1"
MYSQL_PORT="6446"
MYSQL_USER="ku_rms_user"
MYSQL_PASSWORD="Khalifarms#123"
MYSQL_DATABASE="rms_uat"
ELASTIC_USER="elastic"
ELASTIC_PASS="Passw0rd321"
